...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% PREAMBLE
\documentclass[9pt,lessons, pubversion]{livecoms}
...
\newcommand{\githubrepository}{\url{https://github.com/openkinome/kinoml-techpaper-LiveCoMS}}  %this should be the main github repository for this article

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% ARTICLE SETUP
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{The Journey of Data: Lessons Learned in Modeling Kinase Affinity, Selectivity, and Resistance [Article v1.0]}
...
\author[3]{Alexander M. Payne}
\author[3]{Benjamin Kaminow}
\author[3]{Iv\'{a}n Pulido}
\author[3]{Sukrit Singh}
\author[2]{Paula Linh Kramer}
\author[1,2,3]{Guillermo P\'{e}rez-Hern\'{a}ndez}
...
\corr{volkamer@cs.uni-saarland.de}{AV}
...
\orcid{Michael Backenköhler}{0000-0002-7913-2932}
\orcid{Joschka Groß}{0000-0002-8957-8807}
\orcid{Alexander M. Payne}{0000-0003-0947-0191}
\orcid{Benjamin Kaminow}{0000-0002-2266-3353}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\pubDOI{10.33011/livecoms.6.1.3875}
\pubvolume{6}
\pubissue{1}
\pubyear{2025}
\articlenum{3875}
\datereceived{March 26, 2025}
\dateaccepted{October 20, 2025}
...
This reaction is catalyzed by a class of enzymes called kinases, of which there are nearly 540 unique human proteins.~\cite{eid2017kinmap} 
...
%It is hypothesized that incorporating structural data into the ML model could improve the binding affinity predictions~\cite{schaller2023benchmarking, backenkohler2023guided}, thus, potentially exceeding the performance of ligand-based methods.
...
%Furthermore, although there is more available compound affinity data than complex structure data, leveraging all available kinase data for all targets may overcome this limitation.
...
In order to describe our experiences in building such a framework, we will first dive into how to obtain and deposit data from different sources in a \revision{findable, accessible, interoperable and reproducible (FAIR)  \cite{wilkinson2016fair} } way, including how to preprocess the data properly. 
...
In this case, it is recommended to directly contact the authors. Moreover, when considering which licensing scheme to use for your own data, it is recommended to use the \href{https://creativecommons.org/public-domain/cc0/}{CC0} (public domain) license \cite{labastida2020licensing}. This type of licensing allows data to be treated as if it is in the public domain, facilitating aggregation of data into other repositories, thereby promoting collaborations and knowledge sharing. 
...
%For bigger datasets, like those coming from molecular dynamics simulations, special arrangements can be done with reproducible science initiatives ([mention here the AWS archive, GitHub glaciar, and all those mentioned in F@H backups]).
...
Several nomenclatures exist to refer to kinases, i.e., xName \href{http://www.kinhub.org/kinases.html}{(KinHub)}, Manning's kinase classification \cite{Manning2002}, or HUGO Gene Nomenclature Committee (HGNC) \cite{eyre2006hugo}. 
...
For this purpose, we considered two online databases: ChEMBL \cite{zdrazil2024chembl} and PKIS2 \cite{drewry2017progress}. 
...
%The other difficulty in this dataset is the type of measurement. 
...
Harmonizing ligand data poses challenges analogous to the kinase targets while along unique concerns, including a generally less standardized identifier generation process and the need to remedy of non-canonical or degenerate molecular representations. %\revision{Note that in this work, we restrict our analysis to ATP-competitive, non-covalent kinase inhibitors. Covalent warhead inhibitors, although pharmacologically important for kinases, were not included due to their different binding modalities which require separate treatment beyond the scope of this study.}
\begin{itemize}
...
All code is available under the MIT license at the openkinome organization \url{https://github.com/openkinome}. The data acquisition is available under \url{https://github.com/openkinome/kinodata}. The KinoML software is available under \url{https://github.com/openkinome/kinoml}.
